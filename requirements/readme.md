...
**first** integer represents the bus **route routeId**. The bus route routeId is unique
among all other bus route ids in the input. The remaining integers in the list
represent a list of **station ids**. A station routeId may occur in multiple bus
